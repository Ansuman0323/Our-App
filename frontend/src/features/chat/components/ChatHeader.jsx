        ...
        >
            ...
            <div className="flex items-center gap-2 shrink-0">
                ...
                <motion.button
                    ...
                    className="flex items-center justify-center w-11 h-11 rounded-full bg-slate-100 hover:bg-slate-200 text-indigo-600 disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:ring-offset-2"
